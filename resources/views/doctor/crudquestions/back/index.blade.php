    ...
    <x-app-layout>
     ...
     <div class="row font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight"style="font-size :18px ;color:aqua;text-align:center">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                <td>{{ ++$i }}</td>
                <td style="text-align: center">{{ $questionsBack->question }}</td>

                <td>
                    <form action="{{ route('questionsBack.destroy',$questionsBack->id) }}" method="POST">

                        <a class="custom-btn btn-10"style="margin-left:20px;text-align: center"  href="{{ route('questionsBack.show',$questionsBack->id) }}"style="margin:10px;text-align: center" >التفاصيل</a>

                        <a class="custom-btn btn-14" style="margin-left:20px;margin-top:5px;text-align: center" href="{{ route('questionsBack.edit',$questionsBack->id) }}"style="margin:10px;text-align: center" >التعديل</a>

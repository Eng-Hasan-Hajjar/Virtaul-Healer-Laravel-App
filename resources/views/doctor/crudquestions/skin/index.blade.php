            ...
            <tr>
                ...
                <td>
                    <form action="{{ route('questionsSkin.destroy',$questionsSkin->id) }}" method="POST">
                        ...
                        <a class="custom-btn btn-10"style="margin-left:16px"  href="{{ route('questionsSkin.show',$questionsSkin->id) }}"style="margin:20px">التفاصيل</a>

                        <a class="custom-btn btn-14" style="margin-left:16px;margin-top:5px" href="{{ route('questionsSkin.edit',$questionsSkin->id) }}"style="margin:20px">التعديل</a>

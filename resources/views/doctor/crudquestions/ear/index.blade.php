            ...
            <tr>
                ...
                <td>
                    <form action="{{ route('questionsEar.destroy',$questionsEar->id) }}" method="POST">
                        ...
                        <a class="custom-btn btn-10"style="margin-left:16px"  href="{{ route('questionsEar.show',$questionsEar->id) }}">التفاصيل</a>

                        <a class="custom-btn btn-14" style="margin-left:16px;margin-top:5px" href="{{ route('questionsEar.edit',$questionsEar->id) }}">التعديل</a>

    ...
    <x-app-layout>
     ...
     <div class="row font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight"style="font-size :18px ;color:aqua;text-align:center">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                <td>{{ ++$i }}</td>
                <td>{{ $questionsEar->question }}</td>

                <td>
                    <form action="{{ route('questionsEar.destroy',$questionsEar->id) }}" method="POST">

                        <a class="custom-btn btn-10"style="margin-left:16px"  href="{{ route('questionsEar.show',$questionsEar->id) }}"style="margin:20px">التفاصيل</a>

                        <a class="custom-btn btn-14" style="margin-left:16px;margin-top:5px" href="{{ route('questionsEar.edit',$questionsEar->id) }}"style="margin:20px">التعديل</a>

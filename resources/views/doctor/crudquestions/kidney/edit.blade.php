    ...
    <x-app-layout>
        ...
        <form action="{{ route('questionsKidney.update', $questionsKidney->id) }}" method="POST"style="color:#000;">
            @csrf
            @method('PUT')
             ...
             <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group" style="margin:50px">
                        ...
                        <input type="text" style="width:60%;text-align:center" name="question" value="{{ $questionsKidney->question }}" class="form-control" placeholder="السؤال">
                    </div>
                </div>

            ...
            <tr>
                ...
                <td>
                    <form action="{{ route('questionsIntestine.destroy',$questionsIntestine->id) }}" method="POST">
                        ...
                        <a class="custom-btn btn-10"style="margin-left:16px"  href="{{ route('questionsIntestine.show',$questionsIntestine->id) }}">التفاصيل</a>

                        <a class="custom-btn btn-14" style="margin-left:16px;margin-top:5px" href="{{ route('questionsIntestine.edit',$questionsIntestine->id) }}">التعديل</a>

    ...
    <x-app-layout>
        ...
        <form action="{{ route('questionsIntestine.update', $questionsIntestine->id) }}" method="POST"style="color:#000;">
            @csrf
            @method('PUT')
             ...
             <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group" style="margin:50px">
                        ...
                        <input type="text" style="width:60%;text-align:center" name="question" value="{{ $questionsIntestine->question }}" class="form-control" placeholder="السؤال">
                    </div>
                </div>

                <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                  <button type="submit" class="custom-btn btn-2">تعديل</button>
                  <a class="custom-btn btn-6" href="{{ route('questionsIntestine.index') }}"> رجوع</a>

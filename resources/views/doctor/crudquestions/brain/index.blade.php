            ...
            <tr>
                ...
                <td>
                    <form action="{{ route('questionsBrain.destroy',$questionsBrain->id) }}" method="POST">
                        ...
                        <a class="custom-btn btn-10"style="margin-left:17px"  href="{{ route('questionsBrain.show',$questionsBrain->id) }}">التفاصيل</a>

                        <a class="custom-btn btn-14" style="margin-left:17px;margin-top:5px" href="{{ route('questionsBrain.edit',$questionsBrain->id) }}">التعديل</a>

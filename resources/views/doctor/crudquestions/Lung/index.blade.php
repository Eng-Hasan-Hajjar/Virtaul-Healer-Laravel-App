            ...
            <tr>
                ...
                <td>
                    <form action="{{ route('questionsLung.destroy',$questionsLung->id) }}" method="POST">
                        ...
                        <a class="custom-btn btn-10"style="margin-left:16px"  href="{{ route('questionsLung.show',$questionsLung->id) }}">التفاصيل</a>

                        <a class="custom-btn btn-14" style="margin-left:16px;margin-top:5px" href="{{ route('questionsLung.edit',$questionsLung->id) }}">التعديل</a>

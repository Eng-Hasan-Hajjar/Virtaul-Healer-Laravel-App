    ...
    <x-app-layout>
     ...
     <div class="row font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight"style="font-size :18px ;color:aqua;text-align:center">
        ...
        <table class="table table-bordered">
            ...
            @foreach ($questionsEyes as $questionsEye)
            <tr>
                <td>{{ ++$i }}</td>
                <td style="text-align: center">{{ $questionsEye->question }}</td>

                <td>
                    <form action="{{ route('questionsEye.destroy',$questionsEye->id) }}" method="POST">

                        <a class="custom-btn btn-10"style="margin-left:20px;text-align: center"  href="{{ route('questionsEye.show',$questionsEye->id) }}"style="margin:20px;text-align: center">التفاصيل</a>

                        <a class="custom-btn btn-14" style="margin-left:20px;margin-top:5px;text-align: center" href="{{ route('questionsEye.edit',$questionsEye->id) }}"style="margin:20px;text-align: center">التعديل</a>

    ...
    <x-app-layout>
        ...
        <div class="row font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight"style="font-size :18px ;color:aqua;text-align:center">
            ...
            <form action="{{ route('diagnosis.update', $diagnosi->id) }}" method="POST"style="color:#000;">
                @csrf
                @method('PUT')
                 ...
                 <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group" style="margin:50px">
                            ...
                            <input type="text" style="width:80%" name="description" value="{{ $diagnosi->description }}" class="form-control" placeholder="التشخيص">
                        </div>
                    </div>
